		...
		def text = '''\
		 ...
		 div(style : "padding-bottom:12px;margin-left:auto;margin-right:auto;width:80%;background:#fff") {
		    ...
		    div(style : "width:90%;margin:auto;margin-top : 20px;margin-bottom:30px") {
		     ...
		     p("l\'enregistrement de votre domaine web est maintenant termin&eacute;. cliquer sur le bouton Voir pour visualiser les details et vous pourrez l\'administrer en cliquant sur le lien manage un fois que votre compte sera activ&eacute;. nous vous remercions pour votre confiance et restons &agrave; votre enti&eacute;re disposition")
