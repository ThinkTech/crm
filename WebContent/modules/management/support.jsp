...
<div class="window details">
    <div>
		...
		<fieldset>
			...
			<span class="text-right"><i class="fa fa-tasks" aria-hidden="true"></i> Progression </span> <span class="badge badge-info">{progression}%</span> <a><i class="fa fa-edit" aria-hidden="true"></i></a>
		</fieldset>
		<fieldset>
		<fieldset>
		 <legend>
